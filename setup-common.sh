...
# Segment anything
aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/HCMUE-Research/SAM-vit-h/resolve/main/sam_vit_h_4b8939.pth -d /workspace/stable-diffusion-webui/models/sam -o sam_vit_h_4b8939.pth
